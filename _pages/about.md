...
<div style="display: flex; align-items: center; margin-top: 20px;"> <!-- Left side: Image --> 
  <div style="flex: 2; padding-right: 20px;"> <img src="../images/AAA/STA.png" alt="Project Image" style="width: 100%; height: auto;"> 
